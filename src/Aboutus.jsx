...
export default function Aboutus() {
  return (
    <div>
      ...
      <div class="grid gap-4 w-350 ml-90 pt-17">
        <div>
          <img
      ...
      <div className="bg-slate-800">
        <div class="flex items-start gap-2.5 ml-200 pt-10 p-10">
          <img
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4 w-400 ml-69 pt-0">
        <div>
          <img
            class="h-auto max-w-full rounded-lg"
